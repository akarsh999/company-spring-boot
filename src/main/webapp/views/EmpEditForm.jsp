...
<body>
	<form action="updateEmp/${employee.emp_id}" method="post" modelAttribute="Employee">
		...
		<div class="form-group mx-sm-5 mb-2">
			<label for="exampleInputEmail1" class="form-label">User id</label> <input
				...
				placeholder="Enter User ID" value="${employee.emp_id}" name="emp_id"
		...
		<div class="row">
			<div class="col mx-sm-5">
				<label for="exampleInputEmail1" class="form-label">First
					...
					placeholder="Enter First name" value="${employee.first_name}" name="first_name">
			</div>
			<div class="col mx-sm-5 mb-3">
				<label for="exampleInputEmail1" class="form-label">Last Name</label>
				<input type="text" class="form-control"
					placeholder="Enter Last name" value="${employee.last_name}" name="last_name">
			</div>
		</div>
		<!-- <div class="mb-3">
